...
import static com.lazarin.practicing.leetcode.linkedlist.medium.RemoveNthNodeFromEndOfList.traverseList;
...
public class MergeTwoLists {
    ...
    public static void main(String args[]){
        ...
        System.out.println("\nSecond list:");
        traverseList(node2_1);

        var newMergedListHead = mergeTwoLists(node1, node2_1);

        System.out.println("\nFinal list: ");
        traverseList(newMergedListHead);
    }
